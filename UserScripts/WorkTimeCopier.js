...
(function() {
  ...
  const cookieKeyCopyClicked='m510-copy-clicked';
  ...
  const cookieCopyClicked = Cookies.get(cookieKeyCopyClicked);
  ...
  // Copyボタンが押されたCookieが設定済みなら
  if ( cookieCopyClicked ) {
  ...
  function clearForm() {
    ...
    // $('table[summary="管理単位"] input[type="text"]').each(function(index) {
